export default function AnmalRuta(props) {
  return (
    <>
      {props.en ? (
          ...
          <div className="p-1 m-2 sm:p-8 sm:m-16">
            ...
            <ol className="mx-6 my-0 list-decimal">
              ...
              <ul className="ml-8 list-disc ">
                ...
                <li>Adress, postcode and city</li>
                ...
                <li>
                  Which week you want to attend (25, 26 and 32 available, you
          ...
          <div className="p-1 m-2 sm:p-8 sm:m-16">
            ...
            <ol className="mx-6 my-0 list-decimal">
              ...
              <ul className="ml-8 list-disc ">
                ...
                <li>
                  Vilka veckor barnet ska gå (25, 26 och 32  finns, man kan välja
                  1-3st)
                </li>
              </ul>
            </ol>
